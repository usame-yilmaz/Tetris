 ...
 */
public class RightVertical extends Piece {
    public Point[] getShape() {
        ...
        switch (currentPosition)  {
            ...
            case 1 :
                this.currentShape[0] = this.currentStartPoint;
                this.currentShape[1] = createNewPoint(currentStartPoint,0,1);
                this.currentShape[2] = createNewPoint(currentStartPoint,1,0);
                this.currentShape[3] = createNewPoint(currentStartPoint,2,0);
